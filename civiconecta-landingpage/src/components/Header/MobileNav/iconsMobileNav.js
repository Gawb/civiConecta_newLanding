const icons ={
    burgerIcon: <svg className='burger-icon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 61.25">
    ...
    imgLogo: <svg className='img-logo-icon' id="Capa_1" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
    ...
    closeIcon:  <svg className='close-icon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
